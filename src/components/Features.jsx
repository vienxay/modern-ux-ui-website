...
const features = [
  {
    ...
    description:
    "Intelliget code suggestions powered by advanced AI that learns from you coding patterns. Get real-time assistance with syntax, logic, and best practices.",
              ...
              <div 
                ...
                <div className='flex-1 w-full'>
                  <div className='relative group'>
                    ...
                    <div className='relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-2xl
                    p-4 sm:p-6 overflow-hidden group-hover:border-1 group-hover:border-blue-600/50 transition-all duration-300'>
                      {/* IED Interface */}
                      <div className='bg-gray-950 rounded-lg p-3 sm:p-4 font-mono text-sm sm:text-sm'>
