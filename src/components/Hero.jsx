  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center pt-6 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto text-center relative w-full'>
        <div className='max-w-7xl mx-auto flex flex-col lg:grid  lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 items-center relative'>
          <div>
            <div className='inline-flex items-center space-x-2 px-3 sm:py-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700'>
            ...
            <p className='text-md sm:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0 mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed'>
              ...
              Porro tempore distinctio, molestiae repudiandae quos 
              veniam voluptatum ducimus sapiente praesentium consequatur.
            </p>

            <div className='flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-12 aniamate-in-from-bottom duration-700 delay-300'>
            ...
            <div className='relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10'>
                ...
                <div className='p-3 sm:p-4 relative h-full '>
                  ...
                  <div className='flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto'>
                    <button onClick={() => setActiveTab("App.jsx")}
                      ...
                      activeTab === "App.jsx" 
                        ? "bg-blue-500/30 text-white boder-blue-400/20" 
                        : "bg-white/5 text-gray-300 border-white/10 hover:bg-white"
              ...
              <div 
                className={`hidden lg:block absolute bottom-4 right-4 transform translate-x-8 translate-y-8 w-72 ${
                  currentFloatingCard.bgColor} backdrop-blur-xl rounded-lg p-4 border border-white/20 shadow-2xl`}
              >
